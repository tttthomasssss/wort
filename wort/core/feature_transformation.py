...
def ppmi_transformation(PMI, P_w_c, p_w, p_c):
	return PMI


def plmi_transformation(PMI, P_w_c, p_w, p_c): # TODO: Needs testing (pizza_small.txt)
	return P_w_c.multiply(PMI)


def pnpmi_transformation(PMI, P_w_c, p_w, p_c): #TODO: Needs testing (pizza_small.txt)
